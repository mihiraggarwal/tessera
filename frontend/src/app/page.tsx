...
export default function Home() {
  ...
  const [activeHeatmapType, setActiveHeatmapType] = useState<
    "emergency" | "living" | null
  >(null);

  // Route Voronoi state
  const [roadMode, setRoadMode] = useState<
    "euclidean" | "grid" | "edge" | "weighted"
  >("euclidean");
  ...
  const handleHeatmapToggle = useCallback(
    async (type: "emergency" | "living" | null) => {
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    ...
                    <option
                      value="weighted"
                      disabled={routingHealth?.status !== "healthy"}
                    >
                      Road (Weighted)
                    </option>
                    <option
                ...
                {roadMode !== "euclidean" && (
                  <p className="text-xs text-purple-600 -mt-2">
                    ⚠️ Uses OSRM road network. Slower but accounts for actual
                    driving distances.
                  </p>
                )}
